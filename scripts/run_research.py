...
def main():
    ...
    if not features_path.exists():
        print(f"   ❌ Run: python scripts/run_research.py first")
        return
    ...
    # =========================================================
    print("\n" + "="*65)
    print("🎯 STEP 2: Volatility-Only Strategy")
    print("="*65)
    ...
    # =========================================================
    print("\n" + "="*65)
    print("📈 STEP 3: Creating Volatility Score")
    print("="*65)
    ...
    # =========================================================
    print("\n" + "="*65)
    print("🤖 STEP 4: Walk-Forward Validation (Rule-Based)")
    print("="*65)
   ...
   ╚══════════════════════════════════════════════════════════╝
    ...
    print(f"   ✅ Results: validation_results_v3_volatility.csv")
    
    if all_predictions:
        preds = pd.concat(all_predictions, ignore_index=True)
        preds.to_csv(results_dir / "predictions_v3_volatility.csv", index=False)
        print(f"   ✅ Predictions: predictions_v3_volatility.csv ({len(preds):,} rows)")
